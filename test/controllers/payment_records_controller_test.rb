...
class PaymentRecordsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create payment_record" do
    assert_difference('PaymentRecord.count') do
      post payment_records_url, params: { payment_record: { money: @payment_record.money, name: @payment_record.name } }
    end
  ...
  test "should update payment_record" do
    patch payment_record_url(@payment_record), params: { payment_record: { money: @payment_record.money, name: @payment_record.name } }
